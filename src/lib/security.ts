...
export const SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    "connect-src 'self' https://challenges.cloudflare.com https://api.github.com https://cloudflareinsights.com https://www.google-analytics.com https://region1.google-analytics.com https://analytics.google.com",
    "base-uri 'self'",
    "form-action 'self'",
